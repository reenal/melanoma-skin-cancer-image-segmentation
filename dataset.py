...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_GT_path', type=str, default='.\\dataset\\train_GT\\')
    ...
    parser.add_argument('--test_GT_path', type=str, default='.\\dataset\\test_GT\\')
